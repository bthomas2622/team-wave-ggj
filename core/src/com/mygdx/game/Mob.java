...
public class Mob implements Collideable {
    ...
    public void render(Batch batch) {
        ...
        //batch.draw(wave.dropSprites.first(), wave.dropSprites.first().getX(), wave.dropSprites.first().getY(), wave.dropSprites.first().getOriginX(), wave.dropSprites.first().getOriginY(), wave.dropSprites.first().getWidth(), wave.dropSprites.first().getHeight(), wave.dropSprites.first().getScaleX(), wave.dropSprites.first().getScaleY(), wave.dropSprites.first().getRotation());
        wave.drawWave(batch);
    }
